...
public class ULoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                try {
                    ...
                    if (password.length() > 0 && email.length() > 0) {
                        ...
                        auth.signInWithEmailAndPassword(email, password)
                                .addOnCompleteListener(ULoginActivity.this, new OnCompleteListener<AuthResult>() {
                                    @Override
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (!task.isSuccessful()) {
                                            ...
                                            Intent intent = new Intent(ULoginActivity.this, MapsActivity.class);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ULoginActivity.this, RegisterActivity.class);
                startActivity(intent);
            }
        });
...
//                startActivity(new Intent(getApplicationContext(), ForgetAndChangePasswordActivity.class).putExtra("Mode", 0));
    ...
    protected void onResume() {
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(ULoginActivity.this, MainActivity.class));
            finish();
        }
        super.onResume();
    }
